...
# with command line options: Configuration/GenProduction/python/fragment_phi4_Run2.py --python_filename step1_run2_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:step1.root --conditions 106X_upgrade2018_realistic_v11_L1v1 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 10 --filein file:/eos/cms/store/cmst3/user/gkaratha/SoftBJets/cascade_phi4_run3.lhe
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/fragment_phi4_Run2.py nevts:10'),
