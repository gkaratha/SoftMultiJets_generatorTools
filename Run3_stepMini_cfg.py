...
# with command line options: --python_filename step4_MiniAOD_Run22_4c_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:step4.root --conditions 130X_mcRun3_2023_realistic_postBPix_v2 --step PAT --geometry DB:Extended --filein file:step3.root --era Run3_2023 --no_exec --mc -n 10
from FWCore.ParameterSet.VarParsing import VarParsing

options = VarParsing('python')

options.register('infile', 'reco.root',
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "input gensim file "
)

options.register('output', 'mini',
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "output edm name "
)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:'+options.infile), #('file:step3.root'),
